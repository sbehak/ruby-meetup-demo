...
class AgenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agency" do
    assert_difference("Agency.count") do
      post agencies_url, params: { agency: { host_name: @agency.host_name, name: @agency.name } }
    end
  ...
  test "should update agency" do
    patch agency_url(@agency), params: { agency: { host_name: @agency.host_name, name: @agency.name } }
