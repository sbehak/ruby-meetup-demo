...
class DestinationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create destination" do
    assert_difference("Destination.count") do
      post destinations_url, params: { destination: { agency_id: @destination.agency_id, name: @destination.name } }
    end
  ...
  test "should update destination" do
    patch destination_url(@destination), params: { destination: { agency_id: @destination.agency_id, name: @destination.name } }
